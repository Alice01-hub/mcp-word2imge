...
class AIPICServer {
    ...
    setupTools() {
        // 1. 配置API密钥工具
        this.server.registerTool('configure-api', {
            title: '配置API密钥',
        ...
        // 2. 分析网页内容工具
        this.server.registerTool('analyze-webpage', {
            title: '分析网页内容',
        ...
        // 3. 分析文章内容工具
        this.server.registerTool('analyze-article', {
            title: '分析文章内容',
        ...
        // 4. 生成英文提示词工具
        this.server.registerTool('generate-prompts', {
            title: '生成英文提示词',
        ...
        // 5. 生成图片工具
        this.server.registerTool('generate-images', {
            title: '生成图片',
        ...
        // 6. 一键处理网页工具
        this.server.registerTool('process-webpage-complete', {
            title: '一键处理网页',
    ...
    setupResources() {
        // 服务状态资源
        this.server.registerResource('status', 'aipic://status', {
            title: 'AIPIC服务状态',
        ...
        // 示例提示词资源
        this.server.registerResource('sample-prompts', 'aipic://sample-prompts', {
            title: '示例提示词',
     ...
     * 将生成的图片填充到HTML中
     */
    fillImagesIntoHtml(htmlContent, placeholders, imageResults) {
